...
public class MainActivity extends AppCompatActivity {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]>{
        ...
        protected String[] doInBackground(String... params) {
            String jsonResponse;
            try {
                jsonResponse = NetworkUtils.getResponseFromHttpUrl(NetworkUtils.buildUrl(params[0]));
                String[] response = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,jsonResponse);
                return response;
        ...
        protected void onPostExecute(String[] s) {
            if(s != null && !s.equals("")){
                for (String condition : s){
                    mWeatherTextView.append(condition + "\n\n\n");
                }
            }
        }
    }
